...
$style['travelo_menu'] = '"' . $style['travelo_menu_bg'] . 'padding: 8px 0 8px 0; margin-top:5px; text-align: center; font-size: 14px; width:18%; border-top-style:none; border-bottom-style:none; border-width:1px; border-color:#fff"';
$style['travelo_menu_left'] = '"' . $style['travelo_menu_bg'] . ' padding: 8px 0  8px 0; margin-top:5px; border-left-style:solid; border-top-style:solid; border-bottom-style:solid; border-width:1px; border-color:#fff;  text-align: right; font-size: 14px; width:5%;"';
$style['travelo_menu_right'] = '"' . $style['travelo_menu_bg'] . ' padding: 8px 0 8px 0; margin-top:5px; border-right-style:solid; text-align: center; font-size: 14px; width:5%;"';

//logo
$travelo['intravena_logo_img'] = '<img src="http://intravena.hu/public/whitelabels/intravena/logo/travelo.gif">';
$travelo['confhotel_logo_img'] = '<img src="http://intravena.hu/public/whitelabels/intravena/images/f-confhotel.png">';
//menü

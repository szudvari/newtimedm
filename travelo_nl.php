        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-footer">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="sendingdate" id="sendingdate" placeholder="Dátum" data-bv-notempty="true" data-bv-notempty-message="A mező kitöltése kötelező!">
                </div>
                <div class="form-group">
                    <label>Alap mappa</label>
                    <input class="form-control" type="url" name="folder" id="folder" data-bv-notempty="true" data-bv-notempty-message="A mező kitöltése kötelező!" data-bv-uri-message="A formátum nem megfelelő!">
                    <p class="help-block">Pl.: http://stuff.szallas.travelo.hu/hirlevel/20140101</p>
                </div>
    ...
    <div class="col-md-6">
        <div class="panel panel-primary">
            ...
            <div class="panel-footer">
                ...
                <div class="form-group">
                    <label>Source:</label>
                    <input class="form-control"  type="text" id="analytics_source" name="analytics_source" data-bv-notempty="true" data-bv-notempty-message="A mező kitöltése kötelező!">
                </div>
                <div class="form-group">
                    <label>Medium</label>
    ...
    <div class="panel-footer">
        <div class="row">
            ...
            <div class="form-group col-md-2">
                ...
                <input class="form-control"  type="text" id="menu1" name="menu1" value="közel" data-bv-notempty="true" data-bv-notempty-message="A mező kitöltése kötelező!">
            </div>
...
<div class="col-md-12">
    <h4 class="page-header">Ajánlatok</h4>
                ...
                <div class="panel-footer">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control"  type="file" id="bp_pic" name="bp_pic"  data-bv-notempty="true" data-bv-notempty-message="A mező kitöltése kötelező!">
                        </div>
                        <div class="form-group">
                            <p class="help-block">Analitycs:</p>
                            <input class="form-control"  type="text" id="bp_analytics" name="bp_analytics" data-bv-notempty="true" data-bv-notempty-message="A mező kitöltése kötelező!">
                        </div>
                        <div class="form-group">
                            <p class="help-block">Legjobb ár:</p>
                            <input class="form-control"  type="text" id="bp_price" name="bp_price" data-bv-notempty="true" data-bv-notempty-message="A mező kitöltése kötelező!">
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
                    ...
                    <div class="alert alert-info" style="min-height: 53px;">
                        ...
                        <div class="form-group col-md-3">
                            <label for="b_b" class="radio-inline">
                                <input type="radio" id="b_b" name="ad2_ok" value="b_b">Banner + Banner</label></div>
                        <div class="form-group col-md-3">
                            <label for="b2_sz" class="radio-inline">                                
                                <input type="radio" id="b2_sz" name="ad2_ok" value="b2_sz">Banner1 + Szöveges</label></div>
                        <div class="form-group col-md-3">
                            <label for="sz_sz" class="radio-inline"><input type="radio" id="sz_sz" name="ad2_ok2" value="sz_sz">Szöveges + Szöveges</label>
                        </div>
                    </div>
